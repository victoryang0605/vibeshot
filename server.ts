...
【写作铁律】所有文案必须：
- 摒弃一切陈词滥调与套话，严禁出现"时光荏苒""岁月静好""诗和远方""最好的时光""治愈系"等词；
- 用具体、细腻、克制的细节与意象说话（如具体的时间、距离、物件、光线、温度），像真正的电影旁白与高级杂志文案；
- 中文文案 40-70 字为宜，一句成型，不要写成两段；
- 四种风格要差异化明显，避免内容互相重复。

【风格校准参考（非抄袭，仅用于校准语感）】
王家卫风："下午三点，我买了三十罐凤梨罐头。如果记忆也有保质期，我希望它是一万年。"
日系物哀风："风把窗帘吹成浪的形状。桌上的茶凉了，光线正一寸一寸退到墙角。"
法式松弛风："不必解释的松弛，是最高级的盛装。留三成沉默给未知，剩下的交给风。"
深夜治愈风："把今天所有的兵荒马乱折好，放进黄昏的口袋。晚安，世界。"
...
2. 创作 4 种不同高定风格的双语电影台词与极简文案 (quotes)，中文 + 自然流畅的英文译文：
   - wongKarWai (王家卫电影独白): 冷峻、克制、具体的细节（精确到时刻如"下午三点十七分"、距离、罐头/机票/灯等物件；严禁出现年月日，如"一九九四年"这类日期一律不得出现），充满疏离与宿命感。
   - japaneseMinimal (日系物哀极简风): 光影、微风、器物、四季的具体细节，留白与禅意，安静不煽情。
   - frenchChic (法式杂志/松弛感): Effortless chic、不讨好的高级松弛，简洁、有锋芒、略带戏谑。
   - lateNight (深夜治愈/解药): 给疲惫者的具体安慰，温柔但不空洞，避免鸡汤。
